...
class Ui_Project_Main(object):
    ...
    def setupUi(self, Project_Main):
        ...
        # self.change_email_btn = QtWidgets.QPushButton(self.widget)
        # self.change_email_btn.setObjectName("change_email_btn")
        # self.horizontalLayout_3.addWidget(self.change_email_btn)
    ...
    def retranslateUi(self, Project_Main):
        ...
        # self.change_email_btn.setText(_translate("Project_Main", "Change Email"))
