...
class Ui_ConstructReport(object):
    ...
    def scatter_plot(self, df, a, b):
        ...
        title1 = a.capitalize()
        title2 = b.capitalize()
        ax.title.set_text(f"{title1} and {title2}")
        self.position += 1

    # makes bar chart (both values are numbers)
    ...
    # makes bar chart(one string and one number)
    ...
    def histogram(self, df, value):
        ...
        ax.title.set_text(f"{title} Frequency")
    ...
    def word_table(self, df, value):
        ...
        title = value.capitalize()
        table1.columns = [title, 'Frequency']
        df = pd.DataFrame(table1, columns=table1.columns)
        ax.table(cellText=df.values, colLabels=df.columns, loc='upper left')
        self.position += 1
    ...
    def drawing_graph(self):
        ...
        self.ui.figure.subplots_adjust(left=0.1, bottom=0.1, right=0.9, top=0.9, wspace=0.4, hspace=0.65)
    ...
    def setupUi(self, ConstructReport):
        ...
        ConstructReport.resize(1357, 739)
